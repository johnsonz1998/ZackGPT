...
from src.zackgpt.core.thread_manager import (
...
class TestThreadOperations:
    ...
    def test_create_thread(self, thread_manager):
        ...
        thread = thread_manager.create_thread("New Test Thread")
    ...
    def test_get_thread(self, thread_manager):
        ...
        created_thread = thread_manager.create_thread("Test Thread")
        retrieved_thread = thread_manager.get_thread(created_thread.id)
    ...
    def test_update_thread(self, thread_manager):
        ...
        # First create a thread
        thread = thread_manager.create_thread("Original Title")
        new_title = "Updated Title"
        success = thread_manager.update_thread(thread.id, title=new_title)
        assert success
        
        updated_thread = thread_manager.get_thread(thread.id)
        assert updated_thread.title == new_title
    
    def test_delete_thread(self, thread_manager):
        """Test deleting a thread."""
        # First create a thread
        thread = thread_manager.create_thread("Thread to Delete")
        success = thread_manager.delete_thread(thread.id)
        assert success
        
        # Verify thread is deleted
        deleted_thread = thread_manager.get_thread(thread.id)
